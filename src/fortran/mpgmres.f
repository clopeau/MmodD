c-----------------------------------------------------------------------
       subroutine mpgmres(n, np, imk, rhs, sol, vv, eps, maxits, iout,
...
c imk    == size of krylov subspace:  should not exceed 50 in this      *
...
c work arrays:                                                         *
c=============                                                         *
c vv    == work array of length  n x (imk+1) (used to store the Arnoli *
c          basis)                                                      *
c----------------------------------------------------------------------*
...
c     ** initialize 1-st term  of rhs of hessenberg system..
 ...
 4     i=i+1
       its = its + 1
       i1 = i + 1
       call ilucsol (np, vv(1,i), rhs, alu, jlu, ju)
       do 111 j=np+1,n
           rhs(j)=vv(j,i)
 111   continue
...
c
       call ilucsol (np, rhs, rhs, alu, jlu, ju)
