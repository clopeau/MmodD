...
extern void ilucsol_(int * n, double * y, double * x, double * alu, int * jlu, int * ju);
...
extern void mpgmres_(int * n, int * np, int * kry, double * rhs, double * sol, double * w, double * eps, int *niter, int * iout,double * a, int * icol , int * ia, double * alu, int * jlu, int * ju, int * ierr);
...
extern void iluc_(int * n, double * a, int * ja, int * ia, int * lfil, double * droptol, int * param, double * alu, int * jlu, int * ju, int * iwk, double * w, int * jw, int * ierr);
extern void piluc_(int * n, double * a, int * ja, int * ia, int * lfil, double * droptol, double * condest, int * LU, int * param, int * p, int * invq, double * alu, int * jlu, int * ju, int * iwk, double * w, int * jw, int * ierr);
